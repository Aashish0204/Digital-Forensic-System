    ...
    const getCaseFromContract = async () => {
        ...
        if (contract && account) {
            try {
                ...
                const reportId = updatedObj.reportIds;
                ...
                if (updatedObj.labAssigned == "No") {
                    ...
                    console.log(reportDetailsReq);
                    if (reportDetails.reportStatu == "Pending") {
                        setReportS(1);
                        return;
                    }
                    else {
                        ...
                        <div id="display">
                            ...
                            <div id="cocPart">
                                ...
                                <div className="actions" id='actions80'>
                                    <p className='btn grey bold' onClick={handleRefreshCoc}> Refresh</p>
                                </div>
                                <div className="table">
