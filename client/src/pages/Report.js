                    ...
                    <div className="reportActions">
                        <div className="leftOne">{
                            report.reportStatus === "Pending" ?
                                <div className=" action_btns redBg assignLab fs " onClick={markAsDone} id='markDoneBtn'>Pending</div> :
                        ...
                        <div className="rightOne">
                            ...
                            <div className=" action_btns blueBg viewReports" onClick={viewReports} id='viewReportBtn'>View Reports</div>
                            <div className=" action_btns greenBg assignLab" onClick={openPopupReport} >Update Report</div>
                        </div>
